...
const APPNAME_RUNTIME_ENV_KEY: &str = "BGDESK_APPNAME";
#[cfg(windows)]
...
mod win {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_bgdesk.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &Path) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_bgdesk.exe"])
