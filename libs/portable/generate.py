...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("BGDesk  ".encode(encoding=encoding))
...
# Windows: python3 .\generate.py -f ..\bgdesk\flutter\build\windows\runner\Debug\ -o . -e ..\bgdesk\flutter\build\windows\runner\Debug\bgdesk.exe
