...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Připojení se nezdařilo. Zkontrolujte prosím připojení k internetu a zkuste to znovu."),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení BGDesk ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, BGDesk v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, BGDesk již nebude používat UDP 21116, místo toho se použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: BGDesk server OSS tuto funkci neobsahuje."),
