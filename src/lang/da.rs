...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Forbindelsen mislykkedes. Kontroller din internetforbindelse, og prøv igen."),
        ...
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give BGDesk rettigheder til at optage tastetryk"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer BGDesk servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil BGDesk springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil BGDesk ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: BGDesk server OSS indeholder ikke denne funktion."),
