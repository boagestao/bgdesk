...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Veza nije uspjela. Provjerite internetsku vezu i pokušajte ponovno."),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor BGDeska otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa BGDeska"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, BGDesk provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, BGDesk će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, BGDesk više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: BGDesk poslužitelj OSS ne uključuje ovu značajku."),
