...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "കണക്ഷൻ പരാജയപ്പെട്ടു. നിങ്ങളുടെ ഇന്റർനെറ്റ് കണക്ഷൻ പരിശോധിച്ച് വീണ്ടും ശ്രമിക്കുക."),
        ...
        ("android_input_permission_tip2", "സെറ്റിംഗ്സിൽ BGDesk കണ്ടെത്തി അത് ഓൺ ചെയ്യുക."),
        ...
        ("Language", "ഭാഷ"),
        ("Keep BGDesk background service", "BGDesk ബാക്ക്ഗ്രൗണ്ടിൽ പ്രവർത്തിപ്പിക്കുക"),
        ...
        ("verify_rustdesk_password_tip", "BGDesk പാസ്‌വേഡ് പരിശോധിക്കുക"),
        ...
        ("scam_text1", "നിങ്ങൾക്ക് പരിചയമില്ലാത്ത ആരെങ്കിലും BGDesk ഉപയോഗിക്കാൻ ആവശ്യപ്പെട്ടാൽ ഉടൻ കണക്ഷൻ വിച്ഛേദിക്കുക."),
        ...
        ("allow-only-conn-window-open-tip", "BGDesk വിൻഡോ തുറന്നിരിക്കുമ്പോൾ മാത്രം കണക്ഷൻ അനുവദിക്കുക"),
        ...
        ("floating_window_tip", "ബാക്ക്ഗ്രൗണ്ടിലാണെങ്കിലും BGDesk കാണിക്കുക"),
        ...
        ("About BGDesk", "BGDesk-നെ കുറിച്ച്"),
