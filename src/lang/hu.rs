...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A számítógép távoli vezérléséhez a BGDesknek hozzáférési jogokat kell adnia."),
        ("config_screen", "Ahhoz, hogy távolról hozzáférhessen a számítógépéhez, meg kell adnia a BGDesknek a „Képernyőfelvétel” jogosultságot."),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a BGDesk nem fut megfelelően, mint ellenőrzött."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a BGDesk ablaka nyitva van."),
        ...
        ("About BGDesk", "A BGDesk névjegye"),
        ...
        ("allow-insecure-tls-fallback-tip", "Alapértelmezés szerint a BGDesk ellenőrzi a kiszolgáló tanúsítványát a TLS-protokollok esetében. Ha ez a beállítás engedélyezve van, a BGDesk kihagyja az ellenőrzési lépést, és az ellenőrzés sikertelensége esetén folytatja a műveletet."),
        ("Disable UDP", "UDP letiltása"),
        ("disable-udp-tip", "Meghatározza, hogy csak TCP-t használjon-e. Ha ez az beállítás engedélyezve van, a BGDesk nem fogja többé használni a 21116-os UDP-portot, helyette a 21116-os TCP-portot fogja használni."),
        ("server-oss-not-support-tip", "MEGJEGYZÉS: Az OSS BGDesk kiszolgáló nem támogatja ezt a funkciót."),
