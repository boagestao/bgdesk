...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Қосылым сәтсіз аяқталды. Интернет қосылымын тексеріп, қайта көріңіз."),
        ...
        ("config_input", "Қашықтағы жұмыс үстелін пернетақтамен басқару үшін, BGDesk'ке \"Еңгізуді Қадағалау\" рұқсаттарын беруіңіз керек."),
        ("config_microphone", "Қашықтан сөйлесу үшін, BGDesk'ке \"Аудио Жазу\" рұқсаттарын беруіңіз керек."),
        ...
        ("still_click_uac_tip", "Қашықтағы қолданушыдан BGDesk іске қосылған UAC терезесінде OK басуды әлі де талап етеді."),
        ...
        ("verify_rustdesk_password_tip", "BGDesk құпия сөзін тексеру"),
        ...
        ("scam_text1", "Егер сіз танымайтын ЖӘНЕ СЕНБЕЙТІН біреумен телефонмен сөйлесіп жатсаңыз және ол сізден BGDesk қолданып, сербесті іске қосуды сұраса, жалғастырмаңыз да дереу телефонды қойыңыз."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "BGDesk Server Pro'ны {} немесе одан жаңа нұсқаға жаңартуды өтінеміз!"),
        ...
        ("selinux_tip", "Сіздің құрылғыңызда SELinux қосылған, бұл BGDesk'тің басқарылатын жақ ретінде дұрыс жұмыс істеуіне кедергі келтіруі мүмкін."),
        ...
        ("allow-only-conn-window-open-tip", "Тек BGDesk терезесі ашық болғанда ғана қосылымға рұқсат ету"),
        ...
        ("floating_window_tip", "Ол BGDesk артжақ сербесін сақтап тұруға көмектеседі"),
        ...
        ("allow-insecure-tls-fallback-tip", "Әдепкіде BGDesk TLS қолданатын протоколдар үшін сербер сертификатын тексереді.\nБұл опция қосылғанда, BGDesk тексеру сәтсіз болған жағдайда тексеру қадамын өткізіп жіберуге қайтып, жалғастырады."),
        ("Disable UDP", "UDP-ні өшіру"),
        ("disable-udp-tip", "Тек TCP қолданатынын-қолданбайтынын басқарады.\nБұл опция қосылғанда, BGDesk енді UDP 21116 қолданбайды, оның орнына TCP 21116 қолданылады."),
        ("server-oss-not-support-tip", "ЕСКЕРТПЕ: BGDesk server OSS бұл ерекшелікті қамтымайды."),
