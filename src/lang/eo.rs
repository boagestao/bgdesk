...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Konekto malsukcesis. Bonvolu kontroli vian interretan konekton kaj provi denove."),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al BGDesk permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al BGDesk permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta BGDesk."),
        ...
        ("verify_rustdesk_password_tip", "Kontroli BGDesk-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi BGDesk kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bonvolu ĝisdatigi BGDesk Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi BGDesk funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de BGDesk estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de BGDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bonvolu ĝisdatigi la BGDesk-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, BGDesk kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, BGDesk retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, BGDesk ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: BGDesk-servilo OSS ne inkluzivas ĉi tiun funkcion."),
