...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "კავშირი ვერ დამყარდა. გთხოვთ, შეამოწმოთ ინტერნეტ კავშირი და სცადოთ ხელახლა."),
        ...
        ("allow-insecure-tls-fallback-tip", "ნაგულისხმევად BGDesk ამოწმებს სერვერის სერტიფიკატს TLS-ის გამოყენებისას პროტოკოლებისთვის.\nამ პარამეტრის ჩართვისას BGDesk გადავა შემოწმების ეტაპის გამოტოვებაზე და გააგრძელებს მუშაობას შემოწმების წარუმატებლობის შემთხვევაში."),
        ("Disable UDP", "UDP-ის გამორთვა"),
        ("disable-udp-tip", "აკონტროლებს, გამოვიყენოთ თუ არა მხოლოდ TCP.\nამ პარამეტრის ჩართვისას BGDesk აღარ გამოიყენებს UDP 21116-ს, სანაცვლოდ გამოყენებული იქნება TCP 21116."),
        ("server-oss-not-support-tip", "შენიშვნა: BGDesk server OSS არ მოიცავს ამ ფუნქციას."),
