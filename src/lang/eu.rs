...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Konexioak huts egin du. Egiaztatu zure interneteko konexioa eta saiatu berriro."),
        ...
        ("allow-insecure-tls-fallback-tip", "Modu lehenetsian, BGDesk-ek zerbitzariaren ziurtagiria egiaztatzen du TLS erabiltzen duten protokoloetarako.\nAukera hau gaituta dagoela, BGDesk-ek egiaztapen-urratsa saltatzera joko du eta aurrera egingo du egiaztapenak huts eginez gero."),
        ("Disable UDP", "Desgaitu UDP"),
        ("disable-udp-tip", "TCP soilik erabiliko den kontrolatzen du.\nAukera hau gaituta dagoenean, BGDesk-ek ez du gehiago UDP 21116 erabiliko; horren ordez, TCP 21116 erabiliko da."),
        ("server-oss-not-support-tip", "OHARRA: BGDesk zerbitzariaren OSS bertsioak ez du ezaugarri hau barne hartzen."),
