...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Не вдалося підключитися. Перевірте підключення до інтернету та спробуйте ще раз."),
        ...
        ("floating_window_tip", "Допомагає зберегти фонову службу BGDesk"),
        ...
        ("allow-insecure-tls-fallback-tip", "За замовчуванням BGDesk перевіряє сертифікат сервера для протоколів, які використовують TLS.\nКоли цей параметр увімкнено, у разі помилки перевірки BGDesk пропустить крок перевірки та продовжить."),
        ("Disable UDP", "Вимкнути UDP"),
        ("disable-udp-tip", "Визначає, чи використовувати лише TCP.\nКоли цей параметр увімкнено, BGDesk більше не використовуватиме UDP 21116, замість нього буде використано TCP 21116."),
        ("server-oss-not-support-tip", "ПРИМІТКА: сервер BGDesk OSS не містить цієї функції."),
