...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Savienojums neizdevās. Lūdzu, pārbaudiet interneta savienojumu un mēģiniet vēlreiz."),
        ...
        ("allow-insecure-tls-fallback-tip", "Pēc noklusējuma BGDesk pārbauda servera sertifikātu protokoliem, izmantojot TLS.\nJa šī opcija ir iespējota, BGDesk izlaidīs verifikācijas soli un turpinās darbību verifikācijas kļūmes gadījumā."),
        ("Disable UDP", "Atspējot UDP"),
        ("disable-udp-tip", "Nosaka, vai izmantot tikai TCP.\nKad šī opcija ir iespējota, BGDesk vairs neizmantos UDP 21116, tā vietā tiks izmantots TCP 21116."),
        ("server-oss-not-support-tip", "PIEZĪME. BGDesk servera OSS neietver šo funkciju."),
