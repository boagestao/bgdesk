...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Connection failed. Please check your internet connection and try again."),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, BGDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, BGDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, BGDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: BGDesk server OSS doesn't include this feature."),
