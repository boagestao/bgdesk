...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Връзката е неуспешна. Моля, проверете интернет връзката си и опитайте отново."),
        ...
        ("allow-only-conn-window-open-tip", "Разрешаване на връзка само ако прозорецът на BGDesk е отворен"),
        ...
        ("floating_window_tip", "Помага за поддържане на фоновата услуга на BGDesk"),
        ...
        ("allow-insecure-tls-fallback-tip", "По подразбиране BGDesk проверява сертификата на сървъра за протоколи, използващи TLS.\nКогато тази опция е активирана, BGDesk ще пропусне стъпката на проверка и ще продължи в случай на неуспешна проверка."),
        ("Disable UDP", "Забрана на UDP"),
        ("disable-udp-tip", "Управлява дали да се използва само TCP.\nКогато тази опция е активирана, BGDesk вече няма да използва UDP 21116, а вместо това ще се използва TCP 21116."),
        ("server-oss-not-support-tip", "ЗАБЕЛЕЖКА: BGDesk server OSS не включва тази функция."),
