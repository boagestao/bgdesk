...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Nepavyko prisijungti. Patikrinkite interneto ryšį ir bandykite dar kartą."),
        ...
        ("scam_text1", "Jei kalbatės telefonu su žmogumi, kurio NEPAŽĮSTATE ir kuriuo NEPASITIKITE, ir jis paprašė jūsų naudoti BGDesk bei paleisti paslaugą, netęskite ir nedelsdami padėkite ragelį."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prašome atnaujinti BGDesk Server Pro į versiją {} ar naujesnę!"),
        ...
        ("selinux_tip", "Jūsų įrenginyje įjungtas SELinux, kuris gali trukdyti BGDesk tinkamai veikti kaip valdomajai pusei."),
        ...
        ("allow-only-conn-window-open-tip", "Leisti prisijungti tik tada, kai atidarytas BGDesk langas"),
        ...
        ("floating_window_tip", "Tai padeda išlaikyti BGDesk foninę paslaugą"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pagal numatytuosius nustatymus BGDesk tikrina serverio sertifikatą protokoluose, naudojančiuose TLS.\nĮgalinus šią parinktį, patikros nesėkmės atveju BGDesk praleis patikros veiksmą ir tęs darbą."),
        ("Disable UDP", "Išjungti UDP"),
        ("disable-udp-tip", "Nurodo, ar naudoti tik TCP.\nĮgalinus šią parinktį, BGDesk nebenaudos UDP 21116, vietoj jo bus naudojamas TCP 21116."),
        ("server-oss-not-support-tip", "PASTABA: BGDesk serverio OSS šios funkcijos neturi."),
