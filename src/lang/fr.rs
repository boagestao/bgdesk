...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Échec de la connexion. Veuillez vérifier votre connexion Internet et réessayer."),
        ...
        ("allow-insecure-tls-fallback-tip", "Par défaut, BGDesk vérifie le certificat du serveur lors de l’utilisation de protocoles utilisant TLS.\nLorsque cette option est activée, BGDesk autorise les connexions même en cas d’échec de l’étape de vérification."),
        ("Disable UDP", "Désactiver UDP"),
        ("disable-udp-tip", "Contrôle l’utilisation exclusive du mode TCP.\nLorsque cette option est activée, BGDesk n’utilise plus le port UDP 21116 et utilise le port TCP 21116 à la place."),
        ("server-oss-not-support-tip", "Note : Cette fonctionnalité n’est pas disponible sous la version open-source du serveur BGDesk."),
