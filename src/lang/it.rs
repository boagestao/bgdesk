...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Connessione non riuscita. Verifica la connessione a Internet e riprova."),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio BGDesk in background."),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, BGDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, BGDesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, BGDesk non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server BGDesk non include questa funzionalità."),
