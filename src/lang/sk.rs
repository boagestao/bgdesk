...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Pripojenie zlyhalo. Skontrolujte internetové pripojenie a skúste to znova."),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne BGDesk overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou BGDesk v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, BGDesk už nebude používať UDP 21116, namiesto neho sa použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: BGDesk server OSS túto funkciu neobsahuje."),
