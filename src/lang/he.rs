...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "החיבור נכשל. אנא בדוק את חיבור האינטרנט שלך ונסה שוב."),
        ...
        ("allow-insecure-tls-fallback-tip", "כברירת מחדל, BGDesk מאמת את אישור השרת עבור פרוטוקולים המשתמשים ב-TLS.\nכאשר אפשרות זו מופעלת, BGDesk יחזור לדילוג על שלב האימות וימשיך במקרה של כשל באימות."),
        ("Disable UDP", "השבת UDP"),
        ("disable-udp-tip", "קובע אם להשתמש ב-TCP בלבד.\nכאשר אפשרות זו מופעלת, BGDesk לא ישתמש יותר ב-UDP 21116, ובמקום זאת ייעשה שימוש ב-TCP 21116."),
        ("server-oss-not-support-tip", "הערה: גרסת ה-OSS של שרת BGDesk אינה כוללת תכונה זו."),
