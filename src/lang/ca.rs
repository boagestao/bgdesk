...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "La connexió ha fallat. Comproveu la connexió a Internet i torneu-ho a provar."),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Actualitzeu el client BGDesk a la versió {} o superior a la part remota!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per defecte, el BGDesk verifica el certificat del servidor per als protocols que utilitzen TLS.\nAmb aquesta opció habilitada, el BGDesk ometrà el pas de verificació i continuarà en cas que aquesta falli."),
        ("Disable UDP", "Inhabilita l'UDP"),
        ("disable-udp-tip", "Controla si s'utilitza només TCP.\nAmb aquesta opció habilitada, el BGDesk ja no utilitzarà l'UDP 21116, sinó que utilitzarà el TCP 21116 en el seu lloc."),
        ("server-oss-not-support-tip", "NOTA: El BGDesk Server OSS no inclou aquesta característica."),
