...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Veza nije uspela. Proverite internet vezu i pokušajte ponovo."),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite BGDesk-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite BGDesk-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog BGDesk-a."),
        ...
        ("verify_rustdesk_password_tip", "Potvrdi BGDesk lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite BGDesk i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Molimo nadogradite BGDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti BGDesk da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je BGDesk prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se BGDesk pozadinski servis održi"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo nadogradite BGDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, BGDesk proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, BGDesk će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, BGDesk više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: BGDesk server OSS ne uključuje ovu funkciju."),
