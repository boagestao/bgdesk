...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Connessione fallida. Controlla sa connessione a internet e torra a proare."),
        ...
        ("allow-insecure-tls-fallback-tip", "De manera predefinida, BGDesk averguat su certificadu de su serbidore pro sos protocollos chi impreant TLS.\nCun custa optzione ativada, BGDesk at a brincare s'averguada e at a sighire in casu de faddina de averguada."),
        ("Disable UDP", "Disabìlita UDP"),
        ("disable-udp-tip", "Controllat si impreare petzi su TCP.\nCun custa optzione ativada, BGDesk no at a impreare prus sa UDP 21116, ma at a impreare sa TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: su serbidore OSS de BGDesk non includet custa funtzione."),
