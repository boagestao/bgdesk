...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "कनेक्शन विफल रहा। कृपया अपना इंटरनेट कनेक्शन जांचें और पुनः प्रयास करें।"),
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में BGDesk खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep BGDesk background service", "BGDesk बैकग्राउंड सेवा चालू रखें"),
        ...
        ("verify_rustdesk_password_tip", "BGDesk पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे BGDesk उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "BGDesk सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब BGDesk विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान BGDesk को दिखाएं"),
        ...
        ("About BGDesk", "BGDesk के बारे में"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "रिमोट BGDesk क्लाइंट को संस्करण {} में अपग्रेड करें"),
