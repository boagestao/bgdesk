...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Bağlantı başarısız oldu. Lütfen internet bağlantınızı kontrol edin ve tekrar deneyin."),
        ...
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki BGDesk uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden BGDesk'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lütfen BGDesk Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, BGDesk'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca BGDesk penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "BGDesk arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Lütfen uzak tarafta BGDesk istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, BGDesk sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda BGDesk doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, BGDesk artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: BGDesk sunucu OSS'si bu özelliği içermemektedir."),
