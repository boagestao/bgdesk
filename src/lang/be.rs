...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ідзе падключэнне да сеткі BGDesk..."),
        ...
        ("connection_failed_check_internet", "Збой падключэння. Праверце падключэнне да інтэрнэту і паспрабуйце яшчэ раз."),
        ...
        ("install_tip", "У некаторых выпадках з-за UAC, BGDesk можа працаваць на баку абанента неадпаведным чынам. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўсталявання BGDesk у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам трэба дазволіць BGDesk правы \"доступу\""),
        ("config_screen", "Для аддаленага доступу да працоўнага стала вам трэба даць BGDesk правы \"здымку экрана\"."),
        ...
        ("android_input_permission_tip1", "Каб аддаленая прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, трэба дазволіць BGDesk выкарыстоўваць службу \"Спецыяльныя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і перайдзіце ва \"Усталяваныя службы\", уключыце службу \"BGDesk Input\"."),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, трэба дазволіць BGDesk \"Маніторынг уводу\"."),
        ("config_microphone", "Каб размаўляць з абанентам, трэба дазволіць BGDesk запіс аўдыя."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб абанент націснуў \"OK\" ў акне UAC пры запуску BGDesk."),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсьці НЕЗНАЁМЫМ і каму вы НЕ ДАВЕРАЕЦЕ, і гэта асоба просіць вас выкарыстаць BGDesk і запусціць яго службу, не працягвайце і неадкладна скончыце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце BGDesk Server Pro да версіі {} або навейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа ствараць перашкоды ў працы BGDesk на баку абанента."),
        ("Change view", "Рэжым"),
        ...
        ("powered_by_me", "Desenvolvido por Boa Gestão"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць падключэнне толькі пры адкрытым акне BGDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Абнавіце кліент BGDesk да версіі {} або навейшай на баку абанента!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Стандартна BGDesk правярае сертыфікат сервера на наяўнасць пратаколаў, якія выкарыстоўваюць TLS.\nКалі гэта функцыя ўключана, BGDesk прапусціць дадзены этап і працягне працу ў выпадку няўдалай праверкі."),
        ("Disable UDP", "Выключыць UDP"),
        ("disable-udp-tip", "Вызначае, ці варта выкарыстоўваць толькі TCP.\nКалі ўключана, BGDesk не будзе выкарыстоўваць UDP 21116, замест чаго будзе выкарыстоўвацца TCP 21116."),
        ("server-oss-not-support-tip", "ЗАЎВАГА! у OSS-серверы BGDesk гэта функцыя адсутнічае."),
