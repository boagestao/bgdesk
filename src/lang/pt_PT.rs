...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Falha na ligação. Verifique a sua ligação à internet e tente novamente."),
        ...
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação BGDesk, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao BGDesk as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao BGDesk as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do BGDesk em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do BGDesk"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o BGDesk e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o BGDesk Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o BGDesk de funcionar corretamente como lado controlado."),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do BGDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do BGDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente BGDesk para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o BGDesk verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o BGDesk recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o BGDesk deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o BGDesk server OSS não inclui esta funcionalidade."),
