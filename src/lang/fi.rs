...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään BGDesk verkkoon..."),
        ...
        ("connection_failed_check_internet", "Yhteys epäonnistui. Tarkista internetyhteys ja yritä uudelleen."),
        ...
        ("install_tip", "Joissain tapauksissa BGDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi BGDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava BGDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava BGDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten BGDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota BGDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli BGDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "BGDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa BGDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "BGDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep BGDesk background service", "Pidä BGDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista BGDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_rustdesk_password_tip", "Vahvista BGDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "BGDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä BGDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About BGDesk", "Tietoa BGDeskistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-BGDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena BGDesk vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, BGDesk ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, BGDesk ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: BGDesk-palvelimen OSS ei sisällä tätä ominaisuutta."),
