...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "કનેક્શન નિષ્ફળ ગયું. કૃપા કરીને તમારું ઇન્ટરનેટ કનેક્શન તપાસો અને ફરી પ્રયાસ કરો."),
        ...
        ("android_input_permission_tip2", "કૃપા કરીને સેટિંગ્સમાં BGDesk શોધો અને તેને ચાલુ કરો."),
        ...
        ("Language", "ભાષા"),
        ("Keep BGDesk background service", "BGDesk બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("verify_rustdesk_password_tip", "BGDesk પાસવર્ડ ચકાસો"),
        ...
        ("scam_text1", "જો તમે અજાણી વ્યક્તિ સાથે વાત કરી રહ્યા હો અને તેણે BGDesk વાપરવા કહ્યું હોય, તો તરત ડિસ્કનેક્ટ કરો."),
        ...
        ("allow-only-conn-window-open-tip", "માત્ર BGDesk વિન્ડો ખુલ્લી હોય ત્યારે જ કનેક્શનની મંજૂરી આપો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે BGDesk બતાવો"),
