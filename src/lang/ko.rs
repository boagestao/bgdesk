...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "연결에 실패했습니다. 인터넷 연결을 확인한 후 다시 시도하세요."),
        ...
        ("Configure", "구성"),
        ("config_acc", "데스크탑을 원격으로 제어하려면 BGDesk에 \"접근성\" 권한을 부여해야 합니다."),
        ("config_screen", "데스크탑에 원격으로 액세스하려면 BGDesk에 \"화면 녹화\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치 중..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("config_input", "키보드로 원격 데스크탑을 제어하려면 BGDesk에 \"입력 모니터링\" 권한을 부여해야 합니다."),
        ...
        ("allow-insecure-tls-fallback-tip", "기본적으로 BGDesk는 TLS를 사용하여 프로토콜에 대한 서버 인증서를 검증합니다.\n이 옵션을 활성화하면 BGDesk는 인증 단계를 건너뛰고 인증 실패 시 진행합니다."),
        ("Disable UDP", "UDP 사용 안 함"),
        ("disable-udp-tip", "TCP만 사용할지 여부를 제어합니다.\n이 옵션을 활성화하면 BGDesk는 더 이상 UDP 2116을 사용하지 않고 대신 TCP 2116을 사용합니다."),
        ("server-oss-not-support-tip", "참고: BGDesk 서버 OSS에는 이 기능이 포함되어 있지 않습니다."),
