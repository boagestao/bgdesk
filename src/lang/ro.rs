...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Conexiunea a eșuat. Verifică conexiunea la internet și încearcă din nou."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți BGDesk să utilizeze serviciul „Accesibilitate\"."),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi BGDesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Versiunea serverului BGDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul BGDesk pentru simulare la nivel de kernel"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web BGDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări BGDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("web_id_input_tip", "Introdu ID-ul BGDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului BGDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește BGDesk Pro pentru funcționalitate completă."),
