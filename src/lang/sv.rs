...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Anslutningen misslyckades. Kontrollera din internetanslutning och försök igen."),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge BGDesk behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge BGDesk behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för BGDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera BGDesk-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda BGDesk och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera BGDesk Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra BGDesk från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om BGDesk-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla BGDesk-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera BGDesk-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar BGDesk serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar BGDesk över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder BGDesk inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: BGDesk server OSS inkluderar inte denna funktion."),
