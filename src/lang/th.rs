...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "การเชื่อมต่อล้มเหลว โปรดตรวจสอบการเชื่อมต่ออินเทอร์เน็ตของคุณแล้วลองอีกครั้ง"),
        ...
        ("selinux_tip", "SELinux ถูกเปิดใช้งานบนอุปกรณ์ของคุณ ซึ่งอาจทำให้ BGDesk ทำงานเป็นฝ่ายถูกควบคุมได้ไม่สมบูรณ์"),
        ...
        ("allow-only-conn-window-open-tip", "อนุญาตการเชื่อมต่อเฉพาะเมื่อหน้าต่าง BGDesk เปิดอยู่"),
        ...
        ("floating_window_tip", "ช่วยให้บริการเบื้องหลังของ BGDesk ทำงานต่อเนื่อง"),
        ...
        ("allow-insecure-tls-fallback-tip", "โดยค่าเริ่มต้น BGDesk จะตรวจสอบใบรับรองของเซิร์ฟเวอร์สำหรับโปรโตคอลที่ใช้ TLS\nเมื่อเปิดใช้งานตัวเลือกนี้ BGDesk จะย้อนกลับไปข้ามขั้นตอนการตรวจสอบและดำเนินการต่อในกรณีที่การตรวจสอบล้มเหลว"),
        ("Disable UDP", "ปิดใช้งาน UDP"),
        ("disable-udp-tip", "ควบคุมว่าจะใช้ TCP เท่านั้นหรือไม่\nเมื่อเปิดใช้งานตัวเลือกนี้ BGDesk จะไม่ใช้ UDP 21116 อีกต่อไป และจะใช้ TCP 21116 แทน"),
        ("server-oss-not-support-tip", "หมายเหตุ: BGDesk server OSS ไม่มีคุณสมบัตินี้"),
