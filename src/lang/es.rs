...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Error de conexión. Compruebe su conexión a internet e inténtelo de nuevo."),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, BGDesk verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, BGDesk volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, BGDesk no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor BGDesk OSS no incluye esta característica."),
