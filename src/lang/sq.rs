...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Lidhja dështoi. Ju lutemi kontrolloni lidhjen tuaj me internetin dhe provoni përsëri."),
        ...
        ("config_input", "Për të kontrolluar desktopin në distancë me tastierë, duhet t'i jepni BGDesk lejen \"Monitorimi i hyrjes\"."),
        ("config_microphone", "Për të folur në distancë, duhet t'i jepni BGDesk lejen \"Regjistro audio\"."),
        ...
        ("still_click_uac_tip", "Ende kërkon që përdoruesi në distancë të klikojë OK në dritaren UAC të BGDesk që po funksionon."),
        ...
        ("verify_rustdesk_password_tip", "Verifiko fjalëkalimin e BGDesk"),
        ...
        ("scam_text1", "Nëse jeni në telefon me dikë që NUK e njihni DHE NUK i BESONI, i cili ju ka kërkuar të përdorni BGDesk dhe të nisni shërbimin, mos vazhdoni dhe mbyllni telefonin menjëherë."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ju lutemi përmirësoni BGDesk Server Pro në versionin {} ose më të ri!"),
        ...
        ("selinux_tip", "SELinux është i aktivizuar në pajisjen tuaj, gjë që mund të pengojë BGDesk të funksionojë siç duhet si anë e kontrolluar."),
        ...
        ("allow-only-conn-window-open-tip", "Lejo lidhjen vetëm nëse dritarja e BGDesk është e hapur"),
        ...
        ("floating_window_tip", "Ndihmon për të mbajtur shërbimin në sfond të BGDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Ju lutemi përmirësoni klientin BGDesk në versionin {} ose më të ri në anën në distancë!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Si parazgjedhje, BGDesk verifikon certifikatën e serverit për protokollet që përdorin TLS.\nMe këtë opsion të aktivizuar, BGDesk do të kthehet duke kapërcyer hapin e verifikimit dhe do të vazhdojë në rast dështimi të verifikimit."),
        ("Disable UDP", "Çaktivizo UDP"),
        ("disable-udp-tip", "Kontrollon nëse do të përdoret vetëm TCP.\nKur ky opsion është i aktivizuar, BGDesk nuk do ta përdorë më UDP 21116, në vend të tij do të përdoret TCP 21116."),
        ("server-oss-not-support-tip", "SHËNIM: BGDesk server OSS nuk e përfshin këtë veçori."),
