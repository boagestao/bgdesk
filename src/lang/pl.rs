...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Połączenie nie powiodło się. Sprawdź połączenie z internetem i spróbuj ponownie."),
        ...
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać BGDesk uprawnienia do \"Nagrań audio\"."),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie BGDesk weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, BGDesk pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, BGDesk nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS BGDesk nie obsługuje tej funkcji."),
