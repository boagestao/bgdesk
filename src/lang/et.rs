...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Ühendus ebaõnnestus. Palun kontrollige internetiühendust ja proovige uuesti."),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib BGDesk TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab BGDesk kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta BGDesk enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: BGDeski serveri OSS ei sisalda seda funktsiooni."),
