...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connection_failed_check_internet", "Falha na conexão. Verifique sua conexão com a internet e tente novamente."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o BGDesk verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o BGDesk ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o BGDesk não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor BGDesk OSS não inclui este recurso."),
