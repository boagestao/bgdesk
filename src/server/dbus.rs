...
const DBUS_NAME: &str = "br.com.boagestao.bgdesk";
...
/// `dbus-send --session --print-reply --dest=br.com.boagestao.bgdesk /dbus br.com.boagestao.bgdesk.NewConnection string:'PEER_ID'`
